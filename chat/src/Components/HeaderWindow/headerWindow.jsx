...
//   // console.log(selectedMessages.length > 1);
//   // console.log(selectedMessages.length === 1);
//   // console.log(selectedMessages.userName !== userName);
//   // console.log(
//   //   selectedMessages.length === 1 && selectedMessages.userName !== userName
//   // );
...
//   //console.log(selectedMessages);
//   // console.log(userName);
//   // console.log(selectedMessages[0].FromUser);
//   // console.log(selectedMessages.length === 1);
//   // console.log(selectedMessages[0].FromUser === userName);
//   // console.log(
//   //   selectedMessages.length === 1 && selectedMessages[0].FromUser === userName
//   // );
//   const renderIcons = () => {
//     switch (true) {
...
//         selectedMessages[0].FromUser === userName:
//         return (
//           <>
//             <div>
...
//                   <div className="headerWindow-borderIcon">
//                     <FontAwesomeIcon
//                       icon={faSearch}
//
//                       className="headerWindow-icon"
